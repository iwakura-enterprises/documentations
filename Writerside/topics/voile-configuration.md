...
| `disabledDocumentations`          | List of `String`                      | `[]`              | Disables specified documentations. Specifies either a documentation's group, ID or both in the `group:id` format.                                                                             |
| `disabledTopicIdentifiers`        | List of `String`                      | `[]`              | Disables specified topics. Specifies a topic identifier.                                                                                                                                      |
