...
![Welcome screen](hytale-docs-welcome-screen-1-6-2.png)
...
To disable the Hytale Modding Wiki, see [](hytale-docs-configuration.md).
...
Topics that match the search query are highlighted with blue color. If topic's child topic match the
...
For formatting information, see [](hytale-docs-formatting.md).
