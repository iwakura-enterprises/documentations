...
identifiers in the [](voile-topic-identifiers.md) topic.
...
Topic's locale in the file name is optional. For more information regarding topic localization, see the [](voile-topic-localization.md) topic.
...
For more information regarding topic localization, see the [](voile-topic-localization.md) topic.

## Topic's content

Everything after the front-matter is considered as Markdown content and follows the Markdown syntax. For more information
regarding the Markdown syntax, please see the [](voile-markdown-syntax.md) topic.
