...
At the end of this topic, you will have entire documentation with few topics (and sub-topics), ready for adding
your own topics.

### 1. Installing Voile

Please, see [](Installing-server.md) topic.
...
<procedure title="Creating second topic">
...
<procedure title="Editing the first topic">
...
<procedure title="Current structure">
...
<procedure title="Contents of third topic">
...
Instead of specifying the topic's ID (usually the name of the file), let's specify the subfolder itself.
...
- [](hytale-docs-topic-identifiers.md) - creating references to other topics
- [](hytale-docs-formatting.md) - Formatting in Voile's Markdown
