...
For more information how to specify a locale, please see the [](voile-topic-file.md) topic.
...
![Screenshot of the language change button](locale-change-button-interface-example.png)
...
For more information how to change this value, see the [](voile-configuration.md) topic.
