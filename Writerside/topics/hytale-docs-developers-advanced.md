...
A topics loaded from resources do not support **sub-topics** field in front-matter. Due to technical
...
You may also see [Voile's internal docs](https://github.com/iwakura-enterprises/hytale-docs/tree/main/src/main/resources/internal-docs)
in the GitHub repository. **Make sure to follow the naming convention in the first chapter.**